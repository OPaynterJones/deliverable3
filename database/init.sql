...
('Badminton Taster Session', 'Come down and give badminton a try, all skill levels welcome', 'STV hall 1 (courts 1-4)', '2024-05-12 13:00:00','http://localhost:5000/badminton.jpeg', 5),
('Boxing Fight Night', 'We have a packed night of 8 fights, make sure to get your tickets in advance to ensure your place!', 'Komedia', '2024-05-14 19:00:00', 'http://localhost:5000/images/boxing.jpeg', 8),
('Computer Science pub quiz night', 'Come and join us for this casual pub night, entries are £5 per team', 'The West Gate', '2024-05-12 20:00:00', 'http://localhost:5000/images/compsci.jpeg', 9),
('Cue sports Pool Tournament','Test your skills in our cue sports tournament! Compete against fellow enthusiasts for bragging rights and prizes.', 'SU Pool area', '2024-05-20 18:00:00', 'http://localhost:5000/images/pool.jpeg', 11),
('Cycling Charity Ride', 'Pedal for a cause with our cycling charity ride. Enjoy scenic routes while raising funds for a worthy charity.', 'Starting Point: Outside the STV main entrance', '2024-05-22 10:00:00','http://localhost:5000/images/cycling.jpeg', 12),
('Data Science Symposium', 'Delve into the world of data science with expert speakers and engaging discussions. Open to all curious minds!', 'Tech Hub Auditorium', '2024-05-28 16:00:00','http://localhost:5000/images/datascience.jpeg', 14),
('Dance Showcase', 'Experience an electrifying evening of dance performances showcasing a variety of styles and talents. Don''t miss out!', 'The Dance Studio, the Edge', '2024-05-25 19:00:00','http://localhost:5000/images/dance.jpeg', 13),
('Debate society: Animal testing','Sharpen your argumentative skills and engage in intellectual sparring at our debate meeting. May the most persuasive prevail!', 'Chancellors building 3.06', '2024-05-30 18:00:00', 'http://localhost:5000/images/debate.jpeg', 15),
('Drum and Bass DJ Night', 'Get ready to dance the night away to the beats of drum and bass with top DJs spinning the latest tracks.', 'The Tub (SU)', '2024-06-02 20:00:00', 'http://localhost:5000/images/drumandbase.jpeg', 16),
('Fashion Show Extravaganza', 'Witness the latest trends and designs strut down the runway in our glamorous fashion show extravaganza. A night of style awaits!', 'The Edge Studio 1', '2024-06-05 19:00:00', 'http://localhost:5000/images/fashion.jpeg', 17),
('Finance Workshop Series', 'Gain valuable insights into the world of finance with our comprehensive workshop series led by industry experts.', 'Chancellors Building 1.10', '2024-06-08 13:00:00', 'http://localhost:5000/images/finance.jpeg', 18),
('Fine Art Exhibition Opening', 'Immerse yourself in a world of creativity and beauty at the opening of our fine art exhibition, featuring works by talented local artists.', 'Claverton Rooms', '2024-06-10 15:00:00', 'http://localhost:5000/images/fineart.jpeg', 19),
('Gin pub crawl', 'We''ll be doing a crawl of all the best pubs in Bath (drinking alcohol not required)', 'Start Point: The Cork', '2024-05-12 20:00:00','http://localhost:5000/images/gin.jpeg', 20),
('Golf Tournament', 'Tee off for a day of friendly competition and camaraderie at our golf tournament. Prizes await the top performers!', 'Bath Golf Clubhouse', '2024-05-15 14:00:00', 'http://localhost:5000/images/golf.jpeg', 21),
('Green Party Rally', 'Join us in advocating for environmental sustainability and social justice at our Green Party rally. Together, we can make a difference!', 'City Park Amphitheater', '2024-06-18 13:00:00', 'http://localhost:5000/images/greenparty.jpeg', 22),
('Hockey Trails', 'Come down and see if you have the skills to make it into one of our BUCS teams!', 'Hockey Astro 1, STV', '2024-05-17 12:00:00', 'http://localhost:5000/images/hockey.jpeg', 1),
('Jiu Jitsu Workshop', 'Learn essential techniques and hone your skills in the ancient art of Jiu Jitsu at our hands-on workshop. Beginners welcome!', 'Martial Arts Dojo, STV', '2024-05-22 11:00:00', 'http://localhost:5000/images/jiujitsu.jpeg', 23),
('Lacrosse Skills Clinic', 'Improve your lacrosse skills and techniques with personalized instruction from experienced coaches at our skills clinic.', 'Lacrosse Field', '2024-05-25 14:00:00', 'http://localhost:5000/images/lacrosse.jpeg', 24),
('Left Union Forum', 'Join us for stimulating discussions on progressive politics and social change at the Left Union forum. Your voice matters!', 'Chancellors building 4.02', '2024-05-28 13:00:00', 'http://localhost:5000/images/leftunion.jpeg', 25),
('Model UN Conference', 'Step into the shoes of diplomats and negotiate global issues at our Model UN conference. Diplomacy and debate await!', 'East Building 0.11', '2024-04-30 18:00:00', 'http://localhost:5000/images/modelun.jpeg', 26),
('Music Society - Band Night', 'Be captivated by the melodious performances of our talented musicians and bands at the Student Union.', 'The Plug (SU)', '2024-05-02 19:00:00', 'http://localhost:5000/images/music.jpeg', 27),
('Netball Tournament', 'Shoot, pass, and score your way to victory in our exciting netball tournament. Gather your team and join the competition!', 'Netball Courts 1-4', '2024-05-05 14:00:00', 'http://localhost:5000/images/netball.jpeg', 28),
('Poker Night Showdown', 'Ante up and test your poker face in our high-stakes poker night showdown.', '1 West 1.11', '2024-07-08 19:00:00', 'http://localhost:5000/images/poker.jpeg', 29),
('Political Debate Series', 'Engage in lively debates on pressing political issues at our debate series. A platform for diverse perspectives and constructive dialogue.', '10 West 0.11', '2024-05-10 19:00:00', 'http://localhost:5000/images/politics.jpeg', 30),
('Powerlifting Competition', 'Witness feats of strength and determination at our powerlifting competition. Lifters of all levels welcome to compete!', 'Gym 1', '2024-05-12 13:00:00', 'http://localhost:5000/images/powerlifting.jpeg', 2),
('Rowing - BUCS Regatta', 'One of the biggest and best racing events of the year. From GB trialists to novices we''ll be competing in all levels of sculling and sweeping!', 'holme pierrepont country park, Nottingham', '2024-05-15 09:00:00', 'http://localhost:5000/images/rowing.jpg', 3),
('BUCS Rugby Union vs UWE', 'Experience the intensity and excitement of rugby as we clash against UWE.', 'STV Rugby Pitch (athletcis track)', '2024-05-18 17:00:00','http://localhost:5000/images/rugby.jpeg', 31),
('Sailing Adventure Day', 'Set sail for adventure with our sailing day trip. Whether you''re a novice or seasoned sailor, there''s fun to be had on the open sea!', 'Marina Dock, Southampton', '2024-05-20 08:00:00', 'http://localhost:5000/images/sailing.jpeg', 32),
('Salsa Dance Party', 'Move to the rhythm of salsa music and heat up the dance floor at our salsa dance party. No partner required, just your dancing shoes!', 'The Edge Studio 1', '2024-05-22 15:00:00', 'http://localhost:5000/images/salsa.jpeg', 33),
('Squash Tournament', 'Squash your opponents and claim victory in our fast-paced squash tournament. Test your agility and reflexes on the court!', 'Squash Courts', '2024-05-25 13:00:00', 'http://localhost:5000/images/squash.jpeg', 34),
('Student Theatre Production - Beauty and the Beast', 'Be entertained by the creativity and talent of our student performers in an unforgettable theatre production of Beauty and the Beast. Tickets can be bought online or on the door (if available)', 'The Edge Theater', '2024-05-28','http://localhost:5000/images/theatre.jpeg', 35),
('Swimming Gala', 'Dive into the excitement of our swimming gala, where competitors race for glory in various swimming events', 'Olympic Pool Complex', '2024-05-30', 'http://localhost:5000/images/swimming.jpeg', 36),
('Table Tennis Championship', 'Serve, spin, and smash your way to victory in our table tennis championship. Show off your skills and claim the title!', 'Founders Hall', '2024-05-02', 'http://localhost:5000/images/tabletennis.jpeg', 37),
('Triathlon Challenge', 'Push your limits and test your endurance in our triathlon challenge. Swim, bike, and run your way to the finish line!', 'Starting Line: Bournmouth Beachfront', '2024-05-05', 'http://localhost:5000/images/triathlon.jpeg', 38),
('Urban Dance Workshop', 'Groove to the latest beats and learn urban dance moves from talented instructors at our dynamic workshop.', 'The Edge Studio 2', '2024-05-08', 'http://localhost:5000/images/urbandance.jpeg', 39),
('Water Polo Match vs Cardiff Met', 'Come and support the teams we take on both the mens and womens teams from Cardiff Met!', 'Olympic Swimming Pool, STV', '2024-05-10', 'http://localhost:5000/images/waterpolo.jpeg', 40);
